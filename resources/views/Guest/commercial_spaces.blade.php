            ...
            <div class="carousel-item active">
                ...
                <div class="container mx-auto">
                    ...
                    <div class="btn-container">
                        <h1 class="image-text font-weight-bold uppercase text-light text-uppercase display-1"
                            style="padding-bottom:200px; letter-spacing:2px;">
                            Commercial Space</h1>
        ...
        <div class="container-fluid bg-white" id="section2">
            <div class="row d-flex justify-content-center">
                <div class="col-md-9">
                    ...
                    <div class="row pt-4">
                        <div class="col-md-6">
                            <p class="">Business Name <span class="text-danger">*</span></p>
                            <input type="text" name="business_name" class="form-control"
                                placeholder="Enter Business Name" maxlength="32" required>
                        </div>
                        <div class="col-md-6">
                            <p class="  ">Business Style/Trade Name<span
...
=======
                            ...
                            <input type="number" onKeyPress="if(this.value.length==8) return false;"
                                name="business_landline_no" class="form-control" placeholder="" required>
                        </div>
                        <div class="col-md">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <p class="pt-4">Authorized Representative <span class="text-danger">*</span> </p>
                            <input type="text" name="authorized_representative" class="form-control"
                                placeholder="Enter Name of Authorized Representative" maxlength="32" required>
                        </div>
                        <div class="col-md-6">
>>>>>>> 3db97329e8f71a5dacb672e9905218902d98a76e
