    ...
    <img class="img" src="{{ asset('nvdcpics') }}/NovadeciHomepage.png" style = "width:100%;">
        <h2 class = "image-text font-weight-light uppercase">Welcome to</h2>
            <h1 class="image-text2 font-weight-light uppercase">Novadeci Properties</h1>
                <div class="group">
                    <a href = "#"><p class = "mr-2">hotel </p></a>
                    <a href = "#"><p class = "mr-2">convention center </p></a>
                    <a href = "#"><p class = "mr-2">function rooms </p></a>
                    <a href = "#"><p class = "mr-2">commercial spaces </p></a>
                </div>
</div>
<div class="container-fluid bg-white pt-4">
<p class=" pt-2 pr-6 d-flex justify-content-center text-uppercase position-absolute w-100 align-items-center txt txt1 text-light">our</p>
...
<p class = "pt-5 d-flex justify-content-center text-uppercase txt txt2">services</p>
    <div class="row d-flex justify-content-center pt-4">
        <div class="col-md-3">
            <div class="image-container">
                <a href="{{url('suites') }}">
                    <img class="card-img-top mt-3" src="{{ asset('nvdcpics') }}/Suites.jpg" alt="Card image cap" style="max-height: 12.3rem">
            ...
            <div class="image-container">
                    <a href="{{url('convention_center') }}">
                        <img class="card-img-top mt-3" src="{{ asset('nvdcpics') }}/ConventionCenter.jpg" alt="Card image cap" style="max-height: 12.3rem">
                            <div class="image-overlay card-img-top mt-3" style="max-height: 12.3rem">
                                <p>View</p>
                            </div>
                    </a>
            ...
            <div class="col-md-3">
                <div class="image-container">
                    <a href="{{url('function_room') }}">
                        <img class="card-img-top mt-3" src="{{ asset('nvdcpics') }}/FunctionRooms.jpg" alt="Card image cap" style="max-height: 12.3rem">
                            <div class="image-overlay card-img-top mt-3" style="max-height: 12.3rem">
                                <p>View</p>
                            </div>
                    </a>
            ...
            <div class="col-md-3">
                <div class="image-container">
                    <a href="{{url('commercial_spaces') }}">
                        <img class="card-img-top mt-3" src="{{ asset('nvdcpics') }}/CommercialSpaces.jpg" alt="Card image cap" style="max-height: 12.3rem">
                            <div class="image-overlay card-img-top mt-3" style="max-height: 12.3rem">
                                <p>View</p>
                            </div>
                    </a>
    ...
    <div class="container-fluid bg-white pt-4">
        <div class="card-body">
            <p class="pt-3 pr-7 d-flex justify-content-center text-uppercase position-absolute w-100 align-items-center txt txt1 text-light">Nvdc</p>
                ...
                <div class="row ml-2 pt-4">
                    <div class="col-7">
                        <p class = "txt txt3">The convention center houses function rooms which can accomodate from small groups
                            ...
                            <p class = "txt txt3">Its main activity center, very much appropriate for large-scale events can be filled up to 2,500 guests!
                            </p>
        ...
        <div class="container-fluid bg-white pt-6">
            <div class="card-body">
                ...
                <div class="container-fluid bg-white pt-4 ">
                    <div class="card-body ">
                        <p class="pt-3 pr-7 d-flex justify-content-center text-uppercase position-absolute w-100 align-items-center txt1 text-light txt ">Nvdc</p>
                            <p class = "pt-5 d-flex justify-content-center text-uppercase txt txt2">novadeci properties</p>
                        </div>
                </div>
                <div class="container-fluid bg-white pt-4 ">
            ...
            <div class="text-center mt-7">
                ...
                <div class="row d-flex justify-content-center">
                    <div class="col-md-8 cards1">
                        <div class="shadow1">
                            <div class="mapouter">
                                <div class="gmap_canvas"><iframe class="gmap_iframe" height="400px" width="100%" frameborder="0"
            ...
            <div class="row">
                <div class="col">
                    <div class="dropdown show d-flex justify-content-center">
                        <a class="btn dropdown-toggle uppercase txt5" href="#" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            Convention center
                        </a>
