        ...
        <div class="text-center mt-6">
            <div class="row d-flex justify-content-center">
                ...
                <div class="col-md-6 text-center">
                    ...
                    <br>
                    <br>
                    The creation of the NOVADECI came to the knowledge of the market owner so that, the fear of the market
                    owner
                    ...
                    <br>
                    <br>
                    In 1984, the co-op opened its membership even to non-market vendors. Gradually, the co-op’s membership
                    grew
                    in size and expanded its operations. In 1989, the co-op which was once had no place of its own acquired
                    a
                    lot and built a four storey building located in Novaliches Proper. Nine Years later an additional
                    six-storey
                    building was built besides the first building. NOVADECI adopted the VISION Statement “NOVADECI is the
                    best
                    ...
                    <br>
                    <br>
                    Aside from these services, NOVADECI has launched and implemented some big projects and programs. Among
                    these
