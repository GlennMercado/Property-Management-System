                                ...
                                <tr>
                                    ...
                                    <td>
                                        <button type="button" class="btn btn-primary btn-sm" data-toggle="modal"
                                            data-target="#eventinq">View Appication</button>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
                        ...
                        <table class="table align-items-center">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <a href="#" class="badge-md badge-pill badge-primary">For Approval</a>
                                        (Please check
                                        your email)
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <button type="button" class="btn btn-primary btn-sm" data-toggle="modal"
                                            data-target="#commprev">View Appication</button>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
                            ...
                            <div class="row ">
                                <div class="col-md pt-2">
                                    ...
                                    <input type="text" id="name" name="client_name" class="form-control"
                                        placeholder="Enter client name" maxlength="64" onchange="validateName()" value="{{ $event1->client_name }}"
                                        readonly>
                                ...
                                <div class="col-md pt-2">
                                    ...
                                    <input type="number" onkeypress="if(this.value.length==10) return false;"
                                        ...
                                        onchange="validateContact()" value="{{ $event1->contact_no }}" readonly>
                            ...
                            <div class="row ">
                                <div class="col-md pt-4">
                                    ...
                                    <input type="text" name="contact_person" class="form-control"
                                        ...
                                        onchange="validateContactPerson()" value="{{ $event1->contact_person }}" readonly>
                                ...
                                <div class="col-md pt-4">
                                    ...
                                    <input type="number" onkeypress="if(this.value.length==10) return false;"
                                        ...
                                        id="ContactPersonNum" onchange="validateContactPersonNum()" value="{{ $event1->contact_person_no }}" readonly>
                            ...
                            <div class="row ">
                                <div class="col-md pt-4">
                                    ...
                                    <input type="text" name="billing_address" maxlength="82" class="form-control"
                                        placeholder="Enter billing address" id="address" onchange="validateAddress()" value="{{ $event1->billing_address }}"
                                        readonly>
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <input class="form-control-sm" type="text"
                                                    name="venue" id="specify_venue_text" maxlength="32" value="{{ $event1->venue }}"  readonly>
                                            </div>
                                        </div>
                                    </span>
                                </div>
                                <div class="col-md-12">
                                    <span>
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <input class="form-control-sm" type="text"
                                                    name="caterer" id="specify_caterer_text" maxlength="32" value="{{ $event1->caterer }}" readonly>
                                            </div>
                                        </div>
                                    </span>
                                </div>
                                <div class="col-md-12">
                                    <span>
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <input class="form-control-sm" type="text"
                                                    name="audio_visual" id="specify_audio_visual_text" maxlength="32" value="{{ $event1->audio_visual }}"
                                                    readonly>
                                            </div>
                                        </div>
                                    </span>
                                ...
                                <div class="col-md-12">
                                    <span>
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <input class="form-control-sm" type="text"
                                                    name="concept" id="specify_concept_text" maxlength="32" value="{{ $event1->concept }}" readonly>
                                            </div>
                                        </div>
                                    </span>
                                </div>
                            ...
                            <div class="row d-flex justify-content-center">
                                <div class="col-md-9">
                                    ...
                                    <input type="text" name="business_name" class="form-control mt-2"
                                        placeholder="Enter Business Name" maxlength="64" required="" value="{{ $comm1->business_name }}" readonly>
                                    ...
                                    <input type="text" name="business_style" class="form-control"
                                        placeholder="Enter Business Style/Trade Name" maxlength="64" required="" value="{{ $comm1->business_style }}" readonly>
                                    <p class="pt-4">Business Address <span class="text-danger">*</span> </p>
                                    <input type="text" name="business_address" class="form-control"
                                        placeholder="Enter Business Address" maxlength="64" required="" value="{{ $comm1->business_address }}" readonly>
                                    ...
                                    <div class="row">
                                        <div class="col-md">
                                            ...
                                            <input type="number" onkeypress="if(this.value.length==8) return false;"
                                                ...
                                                required="" value="{{ $comm1->business_landline_no }}" readonly>
                                        </div>
                                        <div class="col-md">
                                            <p class="pt-4">Mobile No. <span class="text-danger">*</span> </p>
                                            <input type="number" onkeypress="if(this.value.length==10) return false;"
                                                name="business_mobile_no" class="form-control" placeholder="09XXXXXXXX"
                                                required="" value="{{ $comm1->business_mobile_no }}" readonly>
                                        </div>
                                    </div>
                                    ...
                                    <input type="text" name="name_of_owner" class="form-control"
                                        placeholder="Enter Name of Owner" maxlength="64" required="" value="{{ $comm1->name_of_owner }}" readonly>

                                    <br>
                                    <p>Spouse <span class="text-danger">*</span> </p>
                                    <input type="text" name="spouse" class="form-control" placeholder="Enter Spouse"
                                        maxlength="64" required="" value="{{ $comm1->spouse }}" readonly>
                                    <br>
                                    <p>Home Address <span class="text-danger">*</span> </p>
                                    <input type="text" name="home_address" class="form-control"
                                        placeholder="Enter Home Address" maxlength="128" required="" value="{{ $comm1->home_address }}" readonly>
                                    <div class="row">
                                        <div class="col">
                                            <br>
                                    ...
                                    <input type="number" name="tax_identification_no" class="form-control"
                                        ...
                                        onkeypress="if(this.value.length==12) return false;" required="" value="{{ $comm1->tax_identification_no }}" readonly>
                                    <br>
                                    ...
                                    <input type="text" name="tax_cert_valid_gov_id" class="form-control"
                                        placeholder="Enter Home Address" maxlength="128" required="" value="{{ $comm1->tax_cert_valid_gov_id }}" readonly>
                                    <p class="mt-6">I certify that all of the information I have provided above is true
                                        and
                                        correct
                                        to the best of my knowledge. I fully understand that all data gathered here are
                                        required for
                                        the evaluation of my application for commercial space lease/rent. I am aware that
