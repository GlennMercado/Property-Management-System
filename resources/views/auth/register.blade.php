                        ...
                        <div class="card-body px-lg-5 py-lg-5">
                                ...
                                <div class="form-group{{ $errors->has('email') ? ' has-danger' : '' }}">
                                    <div class="input-group input-group-alternative mb-3">
                                        ...
                                        <input class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}"
                                            ...
                                            value="{{ old('email') }}" required maxlength="64">
                                    </div>
                                    @if ($errors->has('email'))
                                        <span class="invalid-feedback" style="display: block;" role="alert">
                            ...
                            <div class="form-group">
                                        ...
                                        <div class="custom-control custom-control-alternative custom-checkbox">
                                            ...
                                            <label class="custom-control-label" for="customCheckRegister">
                                                <span class="text-muted">{{ __('I agree with the') }} <a
                                                        ...
                                                        data-target="#ModalPrivacyPolicy">Privacy Policy</a></span>
                                            </label>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="text-center pt-2">
                                    <span class="text-muted text-sm">Already have an account <a
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <p>These Terms of Service (“Terms”, “Terms of Service”) govern your use of our website located at
                            <b>nvdcproperties.com</b> (together or individually “Service”) operated by <b>NVDC
                                Properties</b>.
                        </p>
                        ...
                        <p>If you do not agree with (or cannot comply with) Agreements, then you may not use the Service,
                            but
                            please let us know by emailing at <b>nvdcproperties@gmail.com</b> so we can try to find a
                            solution.
                        ...
                        <p>Any contests, sweepstakes or other promotions (collectively, “Promotions”) made available through
                            ...
                            participate
                            in any Promotions, please review the applicable rules as well as our Privacy Policy. If the
                            rules
                        ...
                        <p>By posting Content on or through Service, You represent and warrant that: (i) Content is yours
                            (you
                            own it) and/or you have the right to use it and the right to grant us the rights and license as
                            provided in these Terms, and (ii) that the posting of your Content on or through Service does
                            not
                            violate the privacy rights, publicity rights, copyrights, contract rights or any other rights of
                            any
                        ...
                        <p>You retain any and all of your rights to any Content you submit, post or display on or through
                            ...
                            publicly
                            display, reproduce, and distribute such Content on and through Service. You agree that this
                            license
                        ...
                        <p>Service is intended only for access and use by individuals at least eighteen (18) years old. By
                            ...
                            of
                            age and with the full authority, right, and capacity to enter into this agreement and abide by
                            all
                        ...
                        <p>You may not use as a username the name of another person or entity or that is not lawfully
                            ...
                            than
                            you, without appropriate authorization. You may not use as a username any name that is
                            offensive,
                            vulgar or obscene.</p>
                        ...
                        <p>If you are a copyright owner, or authorized on behalf of one, and you believe that the
                            ...
                            via
                            email to nvdcproperties@gmail.com, with the subject line: “Copyright Infringement” and include
                            in
                        ...
                        <p>You may provide us either directly at nvdcproperties@gmail.com or via third party sites and tools
                            ...
                            that:
                            (i) you shall not retain, acquire or assert any intellectual property right or other right,
                            title or
                        ...
                        <p>NVDC Properties has no control over, and assumes no responsibility for the content, privacy
                            policies,
                        ...
                        <p>For example, the outlined <a href="https://policymaker.io/terms-and-conditions/">Terms of
                            ...
                            for generating high-quality legal documents. PolicyMaker’s <a
                                href="https://policymaker.io/terms-and-conditions/">Terms and Conditions generator</a> is
                            an
                        ...
                        <p>EXCEPT AS PROHIBITED BY LAW, YOU WILL HOLD US AND OUR OFFICERS, DIRECTORS, EMPLOYEES, AND AGENTS
                            ...
                            AN
                            ACTION OF CONTRACT, NEGLIGENCE, OR OTHER TORTIOUS ACTION, OR ARISING OUT OF OR IN CONNECTION
                            WITH
                            ...
                            DAMAGE. EXCEPT AS PROHIBITED BY LAW, IF THERE IS LIABILITY FOUND ON THE PART OF COMPANY, IT WILL
                            BE
                        ...
                        <p style="margin-top: 5em; font-size: 0.7em;">These <a
                            ...
                            <b>nvdcproperties.com</b> by <a href="https://policymaker.io">PolicyMaker.io</a> on 2022-12-08.
                        </p>
