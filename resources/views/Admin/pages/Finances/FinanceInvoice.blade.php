                ...
                <tbody>
                    @foreach ($list as $lists)
                        <tr>
                            ...
                            <td>
                                <h2 class="display-5" id="date_invoice">
                                    {{ date('F j, Y', strtotime($lists->Check_Out_Date)) }}</h2>
                            </td>
                            <td>
                                <h2 class="display-5">{{ $lists->No_of_Pax }}</h2>
                            </td>
                            <td>
                                <h2 class="display-5 text-green cur1" id="money2">
                                    {{ number_format($lists->Payment, 2, '.', ',') }}</h2>
                ...
                <tbody>
                    @foreach ($list4 as $index => $lists4)
                        <tr>
                            ...
                            <td>
                                <h2 class="display-5 text-green cur1" id="cost{{ $index }}">
                                    {{ number_format($lists4->Cost, 2, '.', ',') }}</h2>
