                ...
                <div class="card shadow">
                    <div class="card-header border-0">
                        <div class="row align-items-center">
                            <div class="col">
                                <h2 class="mb-0 title">Broken / Loss Keys</h3>
                            </div>
                        </div>
                        <br>
                        <div class="row align-items-center">
                        ...
                        <table class="table align-items-center table-flush">
                            <thead class="thead-light">
                                <tr>
                                    ...
                                    <th scope="col" style = "font-size:18px;">Time of Issue</th>
                                    <th scope="col" style = "font-size:18px;">Person Issue</th>
                                    <th scope="col" style = "font-size:18px;">Loss or Damage</th>
