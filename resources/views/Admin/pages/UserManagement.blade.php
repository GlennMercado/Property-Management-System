                ...
                <ul class="nav nav-pills nav-fill flex-column flex-md-row" id="tabs-icons-text" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link mb-sm-3 mb-md-0 active" id="tabs-icons-text-1-tab" data-toggle="tab"
                            ...
                            aria-selected="true">Employee Users</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link mb-sm-3 mb-md-0" id="tabs-icons-text-2-tab" data-toggle="tab"
                            href="#tabs-icons-text-2" role="tab" aria-controls="tabs-icons-text-2"
                            aria-selected="false"> Client Users </a>
                    </li>
                    <li class="nav-item">
                                                    ...
                                                    <td>
                                                        @if ($lists->IsDisabled == false && $lists->IsArchived == false)
                                                            <button class="btn btn-sm btn-warning btn-lg"
                                                                data-toggle="modal"
                                                                data-target="#disable{{ $lists->id }}"><i
                                                                    class="bi bi-person"></i>
                                                            </button>
                                                        @elseif($lists->IsDisabled == true && $lists->IsArchived == false)
                                                            <button class="btn btn-sm btn-success btn-lg"
                                                                data-toggle="modal"
                                                                data-target="#enable{{ $lists->id }}"><i
                                                                    class="bi bi-person"></i>
                                                            </button>
                                                        @endif
                                                ...
                                                <div class="modal fade" id="disable{{ $lists->id }}" tabindex="-1"
                                                    ...
                                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <h4 class="text-center">Do you want to disable <span
                                                                        class="text-danger">{{ $lists->name }}</span>
                                                                    access?</h3>
                                                            </div>
                                                            <div class="modal-footer">
                                                                <button class="btn btn-outline-danger"
                                                                    data-dismiss="modal">Close</button>
                                                                <a href="{{ url('/enable_disable_user', ['id' => $lists->id, 'em' => $lists->email, 'endis' => 'Disabled']) }}"
                                                ...
                                                <div class="modal fade" id="enable{{ $lists->id }}" tabindex="-1"
                                                    ...
                                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <h4 class="text-center">Do you want to enable <span
                                                                        class="text-success">{{ $lists->name }}</span>
                                                                    access?</h3>
                                                            </div>
                                                            <div class="modal-footer">
                                                                <button class="btn btn-outline-danger"
                                                                    data-dismiss="modal">Close</button>
                                                                <a href="{{ url('/enable_disable_user', ['id' => $lists->id, 'em' => $lists->email, 'endis' => 'Enabled']) }}"
                                                                    class="btn btn-success">Yes</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="modal fade" id="archive{{ $lists->id }}" tabindex="-1"
                                                    ...
                                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <h4 class="text-center">Do you want to archive <span
                                                                        class="text-success">{{ $lists->name }}</span>
                                                                    account?</h3>
                                                            </div>
                                                            <div class="modal-footer">
                                                                <button class="btn btn-outline-danger"
                                                                    data-dismiss="modal">Close</button>
                                                                <a href="{{ url('/enable_disable_user', ['id' => $lists->id, 'em' => $lists->email, 'endis' => 'Archived']) }}"
                                                                    class="btn btn-success">Yes</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="modal fade" id="edit{{ $lists->id }}" tabindex="-1"
                                                    ...
                                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <form action="{{ url('/edit_user') }}" class="prevent_submit"
                                        ...
                                        <tbody>
                                            @foreach ($list3 as $lists)
                                                <tr>
                                                    ...
                                                    <td>{{ date('F j, Y', strtotime($lists->updated_at)) }} <br>
                                                        {{ date('h:i:s A', strtotime($lists->updated_at)) }} </td>
                                                </tr>
                                            @endforeach
                                        </tbody>
                                    </table>
