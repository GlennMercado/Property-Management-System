        ...
        <div class="card shadow">
            ...
            <div class="card-body">
                <div class="nav-wrapper">
                    <div id="calendar"></div>
                    <!-- Modal -->
                    <div class="modal fade" id="hotel_reserve" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            ...
                            <div class="modal-body">
                              <ul class="nav nav-pills nav-fill flex-column flex-md-row" id="tabs-icons-text"
                                        ...
                                        <li class="nav-item">
                                            ...
                                            <input class="form-control chck" id="checkout" type="date" onkeydown="return false" id="example-datetime-local-input" required>                     
                                        </li>                              
                                    </ul>
                                    ...
                                    <ul class="nav nav-pills nav-fill flex-column flex-md-row" id="tabs-icons-text"
                                        ...
                                        <li class="nav-item">
                                            ...
                                            <input class="form-control" id="mobile_num" type="tel" minlength="11" maxlength="11" required>
                                        </li>
                                        <li class="nav-item">
                ...
                else
                {
                    ...
                    $('#savebtn').click(function(){
                        ...
                        $.ajax({
                            ...
                            type:"POST",
                            dataType: 'json',
                            data:{room_no, checkin, checkout, pax, mobile_num, guest_name},
                            success:function(response){
                                ...
                                $("#room_no, #checkout, #pax, #mobile_num, #guest_name").val('');
