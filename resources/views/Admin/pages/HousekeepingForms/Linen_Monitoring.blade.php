                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @php 
                                                    ...
                                                    $sql = \DB::select("SELECT CASE WHEN diff_rows > 0 THEN 'Different' ELSE 'Same' END AS Result FROM ( SELECT SUM(CASE WHEN Status != 'Approved' THEN 0 ELSE 1 END) AS diff_rows FROM hotel_room_linens WHERE Room_No = '$roomno') AS derived");
